...
public class bookingModel {
    ...
    public static boolean addBooking(int customerId, int roomId, LocalDate checkInDate, LocalDate checkOutDate, int numberOfGuests, String specialRequests) {
    ...
    public static boolean updateBooking(int bookingId, int customerId, int roomId, LocalDate checkInDate, LocalDate checkOutDate, int numberOfGuests, String specialRequests) throws SQLException {
    ...
    public static class Book {
        ...
        // Constructor
        public Book(int bookingId, int roomId, int customerId, LocalDate newCheckInDate, LocalDate newCheckOutDate, int numberOfGuests, String specialRequests) {
            this.bookingId = bookingId;
            this.customerId = customerId;
            this.roomId = roomId;
            this.checkInDate = checkInDate;
        ...
        public static List<Book> getAllBooking() {
            List<Book> book = new ArrayList<>();
            String sql = "SELECT * FROM bookings";
            try (Connection conn = DBConnector.connect();
                 PreparedStatement pstmt = conn.prepareStatement(sql)) {
